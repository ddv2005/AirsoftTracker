...
#define COLOR_SCR        (IS_LIGHT ? lv_color_hex(0xeaeff3) : lv_color_hex(0x000000))
#define COLOR_SCR_TEXT   (IS_LIGHT ? lv_color_hex(0x3b3e42) : lv_color_hex(0xe7e9ec))

/*BUTTON*/
#define COLOR_BTN           (IS_LIGHT ? lv_color_hex(0xffffff) : lv_color_hex(0x000000))
...
/*BACKGROUND*/
#define COLOR_BG            (IS_LIGHT ? lv_color_hex(0xffffff) : lv_color_hex(0x000000))
#define COLOR_BG_PR         (IS_LIGHT ? lv_color_hex(0xeeeeee) : lv_color_hex(0x101010))
...
#define PAD_DEF (lv_disp_get_size_category(NULL) <= LV_DISP_SIZE_MEDIUM ? LV_DPX(10) : (LV_DPX(15)))
...
static void basic_init(void)
{
    ...
    lv_style_set_radius(&styles->btn, LV_STATE_DEFAULT, LV_DPX(32));
    ...
    lv_style_set_border_width(&styles->btn, LV_STATE_FOCUSED, BORDER_WIDTH*4);
    lv_style_set_border_color(&styles->btn, LV_STATE_FOCUSED, lv_color_lighten(COLOR_BTN_BORDER, LV_OPA_20));
...
static void bar_init(void)
{
    ...
    lv_style_set_border_width(&styles->bar_bg, LV_STATE_FOCUSED, BORDER_WIDTH*4);
    lv_style_set_border_color(&styles->bar_bg, LV_STATE_FOCUSED, lv_color_lighten(COLOR_BTN_BORDER, LV_OPA_20));
